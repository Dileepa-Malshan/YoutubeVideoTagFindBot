...
SEARCH_BUTTON = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('↗ Join Here ↗', url='https://t.me/SL_bot_zone')     
        ],
        [
...
async def start(bot, message):
   await message.reply_text(text = "Join https://t.me/SL_bot_zone ",reply_markup=SEARCH_BUTTON) # Edit start text here
...
async def search(client: Client, query: InlineQuery):
    ...
    if search_query == "":
        await client.answer_inline_query(
            query.id,
            results=answers,
            switch_pm_text="Join https://t.me/SL_bot_zone'",
